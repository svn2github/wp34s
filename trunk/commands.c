...
const struct argcmd argcmds[ NUM_RARG ] = {
	...
	CMDstk(RARG_SWAPX,	&cmdswap,	NUMREG,			"x\027")
	CMDstk(RARG_SWAPY,	&cmdswap,	NUMREG,			"y\027")
	CMDstk(RARG_SWAPZ,	&cmdswap,	NUMREG,			"z\027")
	CMDstk(RARG_SWAPT,	&cmdswap,	NUMREG,			"t\027")
	...
	CMDcstk(RARG_CSWAPX,	&cmdswap,	NUMREG-1,		"\024x\027")
	CMDcstk(RARG_CSWAPZ,	&cmdswap,	NUMREG-1,		"\024z\027")
...
//	CMDcstk(RARG_TEST_ZAPX,	&cmdztest,	NUMREG-1,		"\024x~?")
	...
	CMD(RARG_WARNING,	&cmderr,	MAX_ERROR,		"WARN")
