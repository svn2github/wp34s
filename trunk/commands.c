...
const struct niladic niladics[ NUM_NILADIC ] = {
	...
	FN_I0(OP_FRACDENOM,	&op_fracdenom,		"DENMAX",	"DMAX")
	FN_I1(OP_2FRAC,		&op_2frac,		"DECOMP",	CNULL)
	FUNC0(OP_DENANY,	XNIL(F_DENANY),		"DENANY",	"DANY")
	FUNC0(OP_DENFIX,	XNIL(F_DENFIX),		"DENFIX",	"DFIX")
	FUNC0(OP_DENFAC,	XNIL(F_DENFAC),		"DENFAC",	"DFACT")
