...
const struct monfunc monfuncs[ NUM_MONADIC ] = {
	...
	FUNC(OP_LOG,	&dn_log10,		XMC(cpx_LOG10),	&intLog10,	"LOG\271\270",	"LOG10")
	FUNC(OP_LG2,	&dn_log2,		XMC(cpx_LOG2),	&intLog2,	"LOG\272",	"LOG2")
	...
	FUNC(OP_pdf_Q,	XMR(PDF_Q), 		NOFN,		NOFN,		"\264(x)",	"q(x)")
	FUNC(OP_cdf_Q,	XMR(CDF_Q), 		NOFN,		NOFN,		"\224(x)",	"Q(x)")
	FUNC(OP_qf_Q,	XMR(QF_Q),  		NOFN,		NOFN,		"\224\235(p)",	"INV-Q")
	FUNC(OP_pdf_chi2, XMR(PDF_CHI2),	NOFN,		NOFN,		"\265\232\276",	"chi2")
	...
	FUNC(OP_pdf_Plam, XMR(PDF_POISSON),	NOFN,		NOFN,		"Pois\252\276",	"Poislam-p")
	FUNC(OP_cdf_Plam, XMR(CDF_POISSON),	NOFN,		NOFN,		"Pois\252",	"Poislam")
	FUNC(OP_qf_Plam,  XMR(QF_POISSON),	NOFN,		NOFN,		"Pois\252\235",	"INV-Poislam")
	FUNC(OP_pdf_P,	XMR(PDF_POIS2),		NOFN,		NOFN,		"Poiss\276",	"Poiss-p")
	FUNC(OP_cdf_P,	XMR(CDF_POIS2),		NOFN,		NOFN,		"Poiss",	CNULL)
	FUNC(OP_qf_P,	XMR(QF_POIS2),		NOFN,		NOFN,		"Poiss\235",	"INV-Poiss")
...
#endif
	FUNC(OP_xhat,	&stats_xhat,		NOFN,		NOFN,		"\031",		"ESTx")
	FUNC(OP_yhat,	&stats_yhat,		NOFN,		NOFN,		"\032",		"ESTy")
	FUNC(OP_sigper,	&stats_sigper,		NOFN,		NOFN,		"%\221",	"%SUM")
	FUNC(OP_PERCNT,	XMR(PERCENT),		NOFN,		NOFN,		"%",		CNULL)
	FUNC(OP_PERCHG,	XMR(PERCHG),		NOFN,		NOFN,		"\203%",	"DELTA%")
...
const struct dyfunc dyfuncs[ NUM_DYADIC ] = {
	...
	FUNC(OP_GAMMAP,	&decNumberGammap,	NOFN,		NOFN,		"I\202",	"IGAMMA")
...
const struct niladic niladics[ NUM_NILADIC ] = {
	...
	FN_I2(OP_statGSigma,	&stats_deviations,	"\244\276",	"epsilon-sigma")
	...
	FN_I2(OP_statGMEAN,	&stats_gmean,		"\001g",	"MEAN-g")
	...
	FUNC0(OP_THOUS_ON,	XNIL(E3ON),		"E3ON",		CNULL)
	FUNC0(OP_THOUS_OFF,	XNIL(E3OFF),		"E3OFF",	CNULL)
	...
	FUNC1(OP_ALPHATOX,	&alpha_tox,		"\240\015x",	"aTOx")
	FUNC0(OP_XTOALPHA,	&alpha_fromx,		"x\015\240",	"xTOa")
...
const struct argcmd argcmds[ NUM_RARG ] = {
	...
	CMD(RARG_MESSAGE,	&cmdmsg,	MAX_ERROR,		"MSG",		CNULL)
