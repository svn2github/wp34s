...
#define FUNC(name, d, c, i, fn) { d, c, i, fn },
	...
	FUNC(OP_cdfu_LN,&cdfu_lognormal,	NULL,		NULL,		"LgNrm\016")
	...
	FUNC(OP_cdfu_LG,&cdfu_logistic,		NULL,		NULL,		"Logis\016")
	...
	FUNC(OP_cdfu_C,	&cdfu_cauchy,		NULL,		NULL,		"Cauch\016")
