...
static s_opcode prob_catalogue[] = {
	...
	MON(OP_cdf_B,		"B(n)")
	MON(OP_cdfu_B,		"B\016(n)")
	MON(OP_qf_B,		"B\235(p)")
	MON(OP_pdf_C,		"Cap(x)")
	MON(OP_cdf_C,		"Ca(x)")
	MON(OP_cdfu_C,		"Ca\016(x)")
	MON(OP_qf_C,		"Ca\235(p)")
	MON(OP_pdf_EXP,		"Exp(x)")
	MON(OP_cdf_EXP,		"Ex(x)")
	MON(OP_cdfu_EXP,	"Ex\016(x)")
	MON(OP_qf_EXP,		"Ex/235(p)")
	MON(OP_cdf_F,		"F(x)")
	MON(OP_cdfu_F,		"F\016(x)")
	MON(OP_qf_F,		"F/235(p)")
	MON(OP_pdf_G,		"Geom\276")
	MON(OP_cdf_G,		"Geom")
	MON(OP_cdfu_G,		"Geom\016")
	MON(OP_qf_G,		"Geom/235")
	MON(OP_pdf_LG,		"Lgp(x)")
	MON(OP_cdf_LG,		"Lg(x)")
	MON(OP_cdfu_LG,		"Lg\016(x)")
	MON(OP_qf_LG,		"Lg\235(p)")
	MON(OP_pdf_LN,		"Lnp(x)")
	MON(OP_cdf_LN,		"Ln(x)")
	MON(OP_cdfu_LN,		"Ln\016(x)")
	MON(OP_qf_LN,		"Ln\235(p)")
	MON(OP_pdf_N,		"Np(x)")
	MON(OP_cdf_N,		"N(x)")
	MON(OP_cdfu_N,		"N\016(x)")
	MON(OP_qf_N,		"N\235(p)")
	MON(OP_pdf_P,		"P\276")
	MON(OP_cdf_P,		"P(n)")
	MON(OP_cdfu_P,		"P\016(n)")
	MON(OP_qf_P,		"P/235(p)")
	MON(OP_cdf_T,		"t(x)")
	MON(OP_cdfu_T,		"t\016(x)")
	MON(OP_qf_T,		"t/235(p)")
	MON(OP_pdf_WB,		"WB\276")
	MON(OP_cdf_WB,		"WB(x)")
	MON(OP_cdfu_WB,		"WB\016(x)")
	MON(OP_qf_WB,		"WB/235(p)")
	MON(OP_cdf_chi2,	"\225\232")
	MON(OP_cdfu_chi2,	"\225\232\016")
	MON(OP_qf_chi2,		"\225\232INV")
	MON(OP_pdf_Q,		"\224p(x)")
	MON(OP_cdfu_Q,		"\224\016(x)")
};
