...
#ifdef INFRARED
	RARGCMD(RARG_PRINT_REG,	    "PRNT")
	RARGCMD(RARG_PRINT_BYTE,    "PRNTB")
	RARGCMD(RARG_PRINT_CHAR,    "PRNTC")
	RARGCMD(RARG_PRINT_TAB,     "PRTAB")
	NILIC(OP_PRINT_ADV,	    "PRTADV")
	NILIC(OP_PRINT_ALPHA,	    "PRINT\240")
	NILIC(OP_PRINT_ALPHA_NOADV, "PRNT\240+")
	NILIC(OP_PRINT_PGM,	    "PRTPGM")
	NILIC(OP_PRINT_REGS,	    "PRTREG")
	NILIC(OP_PRINT_SIGMA,	    "PRINT\221")
