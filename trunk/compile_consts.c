...
struct constsml constsml[] = {
	...
	CONSTANT("Wa",		"PC_WGS_A",	"6378137.0"),
	CONSTANT("Wb",		"PC_WGS_B",	"6356752.3142"),
	CONSTANT("We\232",	"PC_WGS_E2",	"6.69437999014E-3"),
	CONSTANT("We'\232",	"PC_WGS_ES2",	"6.73949674228E-3"),
	CONSTANT("Wf\235",	"PC_WGS_F",	"298.257223563"),
	CONSTANT("WGM",		"PC_WGS_GM",	"3986004.418E8"),
	CONSTANT("W\267",	"PC_WGS_OMEGA",	"7292115.0E-11"),
