...
*/
	...
	{ DFLT, "ln2rootEonPI",		"0.6207822376352452223455184457816472122518527279025994683638" },
...
#endif
	SYSCONST("\004RgB",	"INT_R_BOUNDS",	"121.133"),
#if 0
	SYSCONST("\202R",	"GAMMA_R",	"23.118910" ),
	SYSCONST("\202C00",	"GAMMA_C00"	"2.0240434640140357514731512432760E-10" ),
#endif
	SYSCONST("\202C01",	"GAMMA_C01",	"1.5333183020199267370932516012553"     ),
	SYSCONST("\202C02",	"GAMMA_C02",	"-1.1640274608858812982567477805332E1"  ),
	SYSCONST("\202C03",	"GAMMA_C03",	"4.0053698000222503376927701573076E1"   ),
	SYSCONST("\202C04",	"GAMMA_C04",	"-8.2667863469173479039227422723581E1"  ),
	SYSCONST("\202C05",	"GAMMA_C05",	"1.1414465885256804336106748692495E2"   ),
	SYSCONST("\202C06",	"GAMMA_C06",	"-1.1135645608449754488425056563075E2"  ),
	SYSCONST("\202C07",	"GAMMA_C07",	"7.9037451549298877731413453151252E1"   ),
	SYSCONST("\202C08",	"GAMMA_C08",	"-4.1415428804507353801947558814560E1"  ),
	SYSCONST("\202C09",	"GAMMA_C09",	"1.6094742170165161102085734210327E1"   ),
	SYSCONST("\202C10",	"GAMMA_C10",	"-4.6223809979028638614212851576524"    ),
	SYSCONST("\202C11",	"GAMMA_C11",	"9.7030884294357827423006360746167E-1"  ),
	SYSCONST("\202C12",	"GAMMA_C12",	"-1.4607332380456449418243363858893E-1" ),
	SYSCONST("\202C13",	"GAMMA_C13",	"1.5330325530769204955496334450658E-2"  ),
	SYSCONST("\202C14",	"GAMMA_C14",	"-1.0773862404547660506042948153734E-3" ),
	SYSCONST("\202C15",	"GAMMA_C15",	"4.7911128916072940196391032755132E-5"  ),
	SYSCONST("\202C16",	"GAMMA_C16",	"-1.2437781042887028450811158692678E-6" ),
	SYSCONST("\202C17",	"GAMMA_C17",	"1.6751019107496606112103160490729E-8"  ),
	SYSCONST("\202C18",	"GAMMA_C18",	"-9.7674656970897286097939311684868E-11"),
	SYSCONST("\202C19",	"GAMMA_C19",	"1.8326577220560509759575892664132E-13" ),
	SYSCONST("\202C20",	"GAMMA_C20",	"-6.4508377189118502115673823719605E-17"),
	SYSCONST("\202C21",	"GAMMA_C21",	"1.3382662604773700632782310392171E-21" ),
