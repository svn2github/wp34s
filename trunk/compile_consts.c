...
struct constsml constsml[] = {
	...
	CONSTANT("\254\275",	"PC_nn",	"-9.662364E-27"),
	...
	CONSTANT("\261",	"PC_sigma",	"5.6704E-8"),
	CONSTANT("\224",	"PHI",		"1.61803398874989484820458683436563811772030917980576"),
	CONSTANT("\264\270",	"PC_phi0",	"2.067833636E-15"),
...
struct constsml conversions[] = {
	...
	CONV("m",	"yard",		"M_YARD",	"0.9144"),
	CONV("km",	"mile",		"KM_MILE",	"1.609344"),
...
//	CONV("m\232",	"feet\232",	"M_SQFEET",	"0.09290304"),
	CONV("ha",	"acre",		"HA_ACRE",	"0.4046873"),
