...
//	CONSTANT("H\270",	"PC_Hubble",	"70.1"),		// Hubble constant
	...
	SYSCONST("DG36",	"DG36",		"0.0000000000026255035924941114349849457699224429054356369210017862785032"),
	SYSCONST("DG38",	"DG38",		"-0.0000000000000778158612968126536797060028506483439738843001117463080143"),
	SYSCONST("DG40",	"DG40",		"0.0000000000000020729062540666039414933903237765059728759794013840563996"),
#endif
#endif
