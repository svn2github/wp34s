...
__DATA__
# Generated by "./trunk/Linux/calc opcodes > svn_1260.op"
0x0000  cmd ENTER[^]
0x0001  cmd CLx
0x0002  cmd EEX
0x0003  cmd +/-
...
0x0199  cmd SOPEN
0x019a  cmd SCLOSE
0x019b  cmd [alpha]SEND
0x019c  cmd [alpha]RECV
0x0200  cmd FP
0x0201  cmd FLOOR
0x0202  cmd CEIL
0x0203  cmd ROUNDI
...
0x8028  cmd # [alpha]
0x8029  cmd # [gamma]EM
0x802a  cmd # [gamma][sub-p]
0x802b  cmd # [epsilon][sub-0]
0x802c  cmd # [lambda][sub-c]
0x802d  cmd # [lambda][sub-c][sub-n]
0x802e  cmd # [lambda][sub-c][sub-p]
0x802f  cmd # [mu][sub-0]
0x8030  cmd # [mu][sub-B]
0x8031  cmd # [mu][sub-e]
0x8032  cmd # [mu][sub-n]
0x8033  cmd # [mu][sub-p]
0x8034  cmd # [mu][sub-u]
0x8035  cmd # [mu][sub-mu]
0x8036  cmd # [pi]
0x8037  cmd # [sigma][sub-B]
0x8038  cmd # [PHI]
0x8039  cmd # [PHI][sub-0]
0x803a  cmd # [omega]
0x803b  cmd # [infinity]
0x8100  cmd [cmplx]# a
...
0x810c  cmd [cmplx]# GM
0x810d  cmd [cmplx]# h
0x810e  cmd [cmplx]# [h-bar]
0x810f  cmd [cmplx]# k
0x8110  cmd [cmplx]# l[sub-p]
0x8111  cmd [cmplx]# m[sub-e]
0x8112  cmd [cmplx]# m[sub-n]
0x8113  cmd [cmplx]# M[sub-p]
0x8114  cmd [cmplx]# m[sub-p]
0x8115  cmd [cmplx]# m[sub-u]
0x8116  cmd [cmplx]# m[sub-mu]
0x8117  cmd [cmplx]# N[sub-A]
0x8118  cmd [cmplx]# NaN
0x8119  cmd [cmplx]# p[sub-0]
0x811a  cmd [cmplx]# q[sub-p]
0x811b  cmd [cmplx]# R
0x811c  cmd [cmplx]# r[sub-e]
0x811d  cmd [cmplx]# R[sub-infinity]
0x811e  cmd [cmplx]# Sa
0x811f  cmd [cmplx]# Sb
0x8120  cmd [cmplx]# Se[^2]
0x8121  cmd [cmplx]# Se'[^2]
0x8122  cmd [cmplx]# Sf[^-1]
0x8123  cmd [cmplx]# T[sub-0]
0x8124  cmd [cmplx]# t[sub-p]
0x8125  cmd [cmplx]# T[sub-p]
0x8126  cmd [cmplx]# V[sub-m]
0x8127  cmd [cmplx]# Z[sub-0]
0x8128  cmd [cmplx]# [alpha]
0x8129  cmd [cmplx]# [gamma]EM
0x812a  cmd [cmplx]# [gamma][sub-p]
0x812b  cmd [cmplx]# [epsilon][sub-0]
0x812c  cmd [cmplx]# [lambda][sub-c]
0x812d  cmd [cmplx]# [lambda][sub-c][sub-n]
0x812e  cmd [cmplx]# [lambda][sub-c][sub-p]
0x812f  cmd [cmplx]# [mu][sub-0]
0x8130  cmd [cmplx]# [mu][sub-B]
0x8131  cmd [cmplx]# [mu][sub-e]
0x8132  cmd [cmplx]# [mu][sub-n]
0x8133  cmd [cmplx]# [mu][sub-p]
0x8134  cmd [cmplx]# [mu][sub-u]
0x8135  cmd [cmplx]# [mu][sub-mu]
0x8136  cmd [cmplx]# [pi]
0x8137  cmd [cmplx]# [sigma][sub-B]
0x8138  cmd [cmplx]# [PHI]
0x8139  cmd [cmplx]# [PHI][sub-0]
0x813a  cmd [cmplx]# [omega]
0x813b  cmd [cmplx]# [infinity]
0x8200  cmd iC 0
0x8200  arg iC  max=0,indirect
0x8201  cmd iC 1
0x8202  cmd iC 3.75312
0x8203  cmd iC 13.76707
0x8204  cmd iC 0.19883478
0x8205  cmd iC 0.99364934
0x8206  cmd iC 0.01129389
0x8207  cmd iC 0.98238587
0x8208  cmd iC 0.05395845
0x8209  cmd iC 0.76281312
0x820a  cmd iC 0.09238421
0x820b  cmd iC 0.54734932
0x820c  cmd iC 0.11867175
0x820d  cmd iC 0.29697204
0x820e  cmd iC 0.13835773
0x820f  cmd iC 0.95630418
0x8210  cmd iC 0.06591106
0x8211  cmd iC 0.03999630
0x8212  cmd iC 0.85804795
0x8213  cmd iC 0.19884013
0x8214  cmd iC 0.07377747
0x8215  cmd iC 0.66900995
0x8216  cmd iC 0.29186994
0x8217  cmd iC 0.18516678
0x8218  cmd iC 0.48437399
0x8219  cmd iC 0.25345911
0x821a  cmd iC 0.12958509
0x821b  cmd iC 0.13685673
0x821c  cmd iC 0.27931721
0x821d  cmd iC 0.19533070
...
0xfe00  arg STOM  max=112,indirect,stack
0xff00  arg RCLM  max=112,indirect,stack
