...
__DATA__
# Generated by "./trunk/Linux/calc opcodes > svn_1293.op"
0x0000  cmd ENTER[^]
0x0001  cmd CLx
0x0002  cmd EEX
0x0003  cmd +/-
...
0x019c  cmd SOPEN
0x019d  cmd SCLOSE
0x019e  cmd [alpha]SEND
0x019f  cmd [alpha]RECV
0x0200  cmd FP
0x0201  cmd FLOOR
0x0202  cmd CEIL
0x0203  cmd ROUNDI
...
0x2033  cmd # [alpha]
0x2034  cmd # [gamma]EM
0x2035  cmd # [gamma][sub-p]
0x2036  cmd # [epsilon][sub-0]
0x2037  cmd # [lambda][sub-c]
0x2038  cmd # [lambda][sub-c][sub-n]
0x2039  cmd # [lambda][sub-c][sub-p]
0x203a  cmd # [mu][sub-0]
0x203b  cmd # [mu][sub-B]
0x203c  cmd # [mu][sub-e]
0x203d  cmd # [mu][sub-n]
0x203e  cmd # [mu][sub-p]
0x203f  cmd # [mu][sub-u]
0x2040  cmd # [mu][sub-mu]
0x2041  cmd # [pi]
0x2042  cmd # [sigma][sub-B]
0x2043  cmd # [PHI]
0x2044  cmd # [PHI][sub-0]
0x2045  cmd # [omega]
0x2046  cmd # [infinity]
0x2100  cmd [cmplx]# a
0x2101  cmd [cmplx]# a[sub-0]
0x2102  cmd [cmplx]# c
0x2103  cmd [cmplx]# c[sub-1]
0x2104  cmd [cmplx]# c[sub-2]
0x2105  cmd [cmplx]# CG
0x2106  cmd [cmplx]# e
0x2107  cmd [cmplx]# eE
0x2108  cmd [cmplx]# F
0x2109  cmd [cmplx]# F[alpha]
0x210a  cmd [cmplx]# F[delta]
0x210b  cmd [cmplx]# g
0x210c  cmd [cmplx]# G
0x210d  cmd [cmplx]# G[sub-0]
0x210e  cmd [cmplx]# g[sub-e]
0x210f  cmd [cmplx]# GM
0x2110  cmd [cmplx]# h
0x2111  cmd [cmplx]# [h-bar]
0x2112  cmd [cmplx]# k
0x2113  cmd [cmplx]# l[sub-p]
0x2114  cmd [cmplx]# m[sub-e]
0x2115  cmd [cmplx]# m[sub-m]
0x2116  cmd [cmplx]# M[sub-n]
0x2117  cmd [cmplx]# m[sub-p]
0x2118  cmd [cmplx]# M[sub-p]
0x2119  cmd [cmplx]# m[sub-u]
0x211a  cmd [cmplx]# m[sub-mu]
0x211b  cmd [cmplx]# M[sol]
0x211c  cmd [cmplx]# M[terra]
0x211d  cmd [cmplx]# N[sub-A]
0x211e  cmd [cmplx]# NaN
0x211f  cmd [cmplx]# p[sub-0]
0x2120  cmd [cmplx]# q[sub-p]
0x2121  cmd [cmplx]# R
0x2122  cmd [cmplx]# r[sub-e]
0x2123  cmd [cmplx]# R[sub-m]
0x2124  cmd [cmplx]# R[sub-infinity]
0x2125  cmd [cmplx]# R[sol]
0x2126  cmd [cmplx]# R[terra]
0x2127  cmd [cmplx]# Sa
0x2128  cmd [cmplx]# Sb
0x2129  cmd [cmplx]# Se[^2]
0x212a  cmd [cmplx]# Se'[^2]
0x212b  cmd [cmplx]# Sf[^-1]
0x212c  cmd [cmplx]# SM[sub-m]
0x212d  cmd [cmplx]# SM[terra]
0x212e  cmd [cmplx]# T[sub-0]
0x212f  cmd [cmplx]# t[sub-p]
0x2130  cmd [cmplx]# T[sub-p]
0x2131  cmd [cmplx]# V[sub-m]
0x2132  cmd [cmplx]# Z[sub-0]
0x2133  cmd [cmplx]# [alpha]
0x2134  cmd [cmplx]# [gamma]EM
0x2135  cmd [cmplx]# [gamma][sub-p]
0x2136  cmd [cmplx]# [epsilon][sub-0]
0x2137  cmd [cmplx]# [lambda][sub-c]
0x2138  cmd [cmplx]# [lambda][sub-c][sub-n]
0x2139  cmd [cmplx]# [lambda][sub-c][sub-p]
0x213a  cmd [cmplx]# [mu][sub-0]
0x213b  cmd [cmplx]# [mu][sub-B]
0x213c  cmd [cmplx]# [mu][sub-e]
0x213d  cmd [cmplx]# [mu][sub-n]
0x213e  cmd [cmplx]# [mu][sub-p]
0x213f  cmd [cmplx]# [mu][sub-u]
0x2140  cmd [cmplx]# [mu][sub-mu]
0x2141  cmd [cmplx]# [pi]
0x2142  cmd [cmplx]# [sigma][sub-B]
0x2143  cmd [cmplx]# [PHI]
0x2144  cmd [cmplx]# [PHI][sub-0]
0x2145  cmd [cmplx]# [omega]
0x2146  cmd [cmplx]# [infinity]
0x2200  cmd iC 0
...
0x8c00  arg PRCL  max=7,indirect
0x8d00  arg PSTO  max=7,indirect
0x8e00  arg P[<->]  max=7,indirect
