...
__DATA__
# Generated by "./trunk/Linux/calc opcodes > svn_1274.op"
0x0000  cmd ENTER[^]
0x0001  cmd CLx
0x0002  cmd EEX
0x0003  cmd +/-
...
0x2028  cmd # [alpha]
0x2029  cmd # [gamma]EM
0x202a  cmd # [gamma][sub-p]
0x202b  cmd # [epsilon][sub-0]
0x202c  cmd # [lambda][sub-c]
0x202d  cmd # [lambda][sub-c][sub-n]
0x202e  cmd # [lambda][sub-c][sub-p]
0x202f  cmd # [mu][sub-0]
0x2030  cmd # [mu][sub-B]
0x2031  cmd # [mu][sub-e]
0x2032  cmd # [mu][sub-n]
0x2033  cmd # [mu][sub-p]
0x2034  cmd # [mu][sub-u]
0x2035  cmd # [mu][sub-mu]
0x2036  cmd # [pi]
0x2037  cmd # [sigma][sub-B]
0x2038  cmd # [PHI]
0x2039  cmd # [PHI][sub-0]
0x203a  cmd # [omega]
0x203b  cmd # [infinity]
0x2100  cmd [cmplx]# a
...
0x2108  cmd [cmplx]# g
0x2109  cmd [cmplx]# G
0x210a  cmd [cmplx]# G[sub-0]
0x210b  cmd [cmplx]# g[sub-e]
0x210c  cmd [cmplx]# GM
0x210d  cmd [cmplx]# h
0x210e  cmd [cmplx]# [h-bar]
0x210f  cmd [cmplx]# k
0x2110  cmd [cmplx]# l[sub-p]
0x2111  cmd [cmplx]# m[sub-e]
0x2112  cmd [cmplx]# m[sub-n]
0x2113  cmd [cmplx]# M[sub-p]
0x2114  cmd [cmplx]# m[sub-p]
0x2115  cmd [cmplx]# m[sub-u]
0x2116  cmd [cmplx]# m[sub-mu]
0x2117  cmd [cmplx]# N[sub-A]
0x2118  cmd [cmplx]# NaN
0x2119  cmd [cmplx]# p[sub-0]
0x211a  cmd [cmplx]# q[sub-p]
0x211b  cmd [cmplx]# R
0x211c  cmd [cmplx]# r[sub-e]
0x211d  cmd [cmplx]# R[sub-infinity]
0x211e  cmd [cmplx]# Sa
0x211f  cmd [cmplx]# Sb
0x2120  cmd [cmplx]# Se[^2]
0x2121  cmd [cmplx]# Se'[^2]
0x2122  cmd [cmplx]# Sf[^-1]
0x2123  cmd [cmplx]# T[sub-0]
0x2124  cmd [cmplx]# t[sub-p]
0x2125  cmd [cmplx]# T[sub-p]
0x2126  cmd [cmplx]# V[sub-m]
0x2127  cmd [cmplx]# Z[sub-0]
0x2128  cmd [cmplx]# [alpha]
0x2129  cmd [cmplx]# [gamma]EM
0x212a  cmd [cmplx]# [gamma][sub-p]
0x212b  cmd [cmplx]# [epsilon][sub-0]
0x212c  cmd [cmplx]# [lambda][sub-c]
0x212d  cmd [cmplx]# [lambda][sub-c][sub-n]
0x212e  cmd [cmplx]# [lambda][sub-c][sub-p]
0x212f  cmd [cmplx]# [mu][sub-0]
0x2130  cmd [cmplx]# [mu][sub-B]
0x2131  cmd [cmplx]# [mu][sub-e]
0x2132  cmd [cmplx]# [mu][sub-n]
0x2133  cmd [cmplx]# [mu][sub-p]
0x2134  cmd [cmplx]# [mu][sub-u]
0x2135  cmd [cmplx]# [mu][sub-mu]
0x2136  cmd [cmplx]# [pi]
0x2137  cmd [cmplx]# [sigma][sub-B]
0x2138  cmd [cmplx]# [PHI]
0x2139  cmd [cmplx]# [PHI][sub-0]
0x213a  cmd [cmplx]# [omega]
0x213b  cmd [cmplx]# [infinity]
0x2200  cmd iC 0
...
0x850c  cmd l[->]cft
0x850d  cmd cft[->]l
0x850e  cmd ml[->]flozUK
0x850f  cmd flozUK[->]ml
0x8510  cmd ml[->]flozUS
0x8511  cmd flozUS[->]ml
0x8512  cmd cm[->]inches
0x8513  cmd inches[->]cm
0x8514  cmd m[->]fathom
0x8515  cmd fathom[->]m
0x8516  cmd m[->]feet
0x8517  cmd feet[->]m
...
0x853c  cmd W[->]PS(hp)
0x853d  cmd PS(hp)[->]W
0x853e  cmd W[->]HP[sub-e]
0x853f  cmd HP[sub-e][->]W
0x8540  cmd t[->]tons
0x8541  cmd tons[->]t
0x8542  cmd t[->]s.tons
0x8543  cmd s.tons[->]t
