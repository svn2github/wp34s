...
__DATA__
# Generated by "./trunk/Linux/calc opcodes > svn_1329.op"
0x0000  cmd ENTER[^]
0x0001  cmd CLx
0x0002  cmd EEX
0x0003  cmd +/-
...
0x2109  cmd [cmplx]# eE
0x210a  cmd [cmplx]# F
0x210b  cmd [cmplx]# F[alpha]
0x210c  cmd [cmplx]# F[delta]
0x210d  cmd [cmplx]# g
0x210e  cmd [cmplx]# G
0x210f  cmd [cmplx]# G[sub-0]
...
0x2117  cmd [cmplx]# M[sub-m]
0x2118  cmd [cmplx]# m[sub-n]
0x2119  cmd [cmplx]# m[sub-p]
0x211a  cmd [cmplx]# M[sub-p]
0x211b  cmd [cmplx]# m[sub-u]
0x211c  cmd [cmplx]# m[sub-mu]
0x211d  cmd [cmplx]# M[sol]
0x211e  cmd [cmplx]# M[terra]
0x211f  cmd [cmplx]# N[sub-A]
0x2120  cmd [cmplx]# NaN
0x2121  cmd [cmplx]# p[sub-0]
0x2122  cmd [cmplx]# q[sub-p]
0x2123  cmd [cmplx]# R
0x2124  cmd [cmplx]# r[sub-e]
0x2125  cmd [cmplx]# R[sub-m]
0x2126  cmd [cmplx]# R[sub-infinity]
0x2127  cmd [cmplx]# R[sol]
0x2128  cmd [cmplx]# R[terra]
0x2129  cmd [cmplx]# Sa
0x212a  cmd [cmplx]# Sb
0x212b  cmd [cmplx]# Se[^2]
0x212c  cmd [cmplx]# Se'[^2]
0x212d  cmd [cmplx]# Sf[^-1]
