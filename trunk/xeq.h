...
enum {
	...
	OP_cdf_chi2, OP_cdfu_chi2, OP_qf_chi2,
	OP_cdf_T, OP_cdfu_T, OP_qf_T,
	OP_cdf_F, OP_cdfu_F, OP_qf_F,
	OP_pdf_WB, OP_cdf_WB, OP_cdfu_WB, OP_qf_WB,
	OP_pdf_EXP, OP_cdf_EXP, OP_cdfu_EXP, OP_qf_EXP,
	OP_pdf_B, OP_cdf_B, OP_cdfu_B, OP_qf_B,
	OP_pdf_P, OP_cdf_P, OP_cdfu_P, OP_qf_P,
	OP_pdf_G, OP_cdf_G, OP_cdfu_G, OP_qf_G,
	OP_pdf_N, OP_cdf_N, OP_cdfu_N, OP_qf_N,
	OP_pdf_LN, OP_cdf_LN, OP_cdfu_LN, OP_qf_LN,
	OP_pdf_LG, OP_cdf_LG, OP_cdfu_LG, OP_qf_LG,
	OP_pdf_C, OP_cdf_C, OP_cdfu_C, OP_qf_C,
	OP_xhat, OP_yhat,
	OP_sigper,
