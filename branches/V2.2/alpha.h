...
extern void clralpha(decimal64 *, decimal64 *, enum nilop);
extern void cmdalpha(unsigned int, enum rarg);
extern void alpha_ip(unsigned int, enum rarg);
extern void alpha_length(decimal64 *, decimal64 *, enum nilop);
...
extern void alpha_view(decimal64 *, decimal64 *, enum nilop);
extern void alpha_view_reg(unsigned int arg, enum rarg op);
extern void alpha_view_common(int reg);

extern void alpha_tox(decimal64 *, decimal64 *, enum nilop);
extern void alpha_fromx(decimal64 *, decimal64 *, enum nilop);
...
extern void alpha_onoff(decimal64 *, decimal64 *, enum nilop);
