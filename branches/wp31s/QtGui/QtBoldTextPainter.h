...
#ifndef QTBOLDTEXTPAINTER_H_
#define QTBOLDTEXTPAINTER_H_


#include "QtNormalTextPainter.h"

class QtBoldTextPainter: public QtNormalTextPainter
{
public:
	QtBoldTextPainter(QChar aChar);
